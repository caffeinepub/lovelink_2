import { r as reactExports, R as React, j as jsxRuntimeExports, d as ReactDOM, e as cn, c as ue } from "./index-Cbge0aN2.js";
import { C as Coins, B as Button, L as LoaderCircle } from "./button-CA_CyEkB.js";
import { c as composeEventHandlers, P as Presence } from "./index-DbrkZoZc.js";
import { u as useComposedRefs, c as createSlot } from "./index-D0kb9WR5.js";
import { u as useLayoutEffect2, a as useCallbackRef$1, P as Primitive, d as dispatchDiscreteCustomEvent, c as createContextScope, b as createContext2 } from "./Layout-GLYzJk9_.js";
import { X, L as Label, I as Input } from "./label-CqND9K4l.js";
...
import { C as Copy } from "./copy-DFA01MyB.js";
/**
...
function CopyableAddress({ address }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 truncate text-left", children: address }),
        copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3.5 h-3.5 flex-shrink-0 text-green-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-3.5 h-3.5 flex-shrink-0" })
      ]
    }
  );
}
function TipModal({
  ...
  const [activeTab, setActiveTab] = reactExports.useState("AFUK");
  ...
  const handleTip = async () => {
    ...
    if (Number.isNaN(parsed) || parsed <= 0) {
      ue.error(`Please enter a valid ${activeTab} amount`);
      return;
    }
    setIsSending(true);
    ...
    setIsSending(false);
    setSuccess(true);
    ue.success(`${parsed} ${activeTab} tip sent to ${target.name}! 💜`);
    setTimeout(() => {
      setSuccess(false);
      setAmount("");
      onOpenChange(false);
  ...
  const formatDist = (m) => m < 1e3 ? `${m}m away` : `${(m / 1e3).toFixed(1)}km away`;
  const tabStyle = (tab) => ({
    background: activeTab === tab ? "linear-gradient(135deg, oklch(0.55 0.24 295), oklch(0.50 0.26 305), oklch(0.62 0.24 340))" : "oklch(0.18 0.025 265)",
    color: activeTab === tab ? "white" : "oklch(0.60 0.04 265)",
    border: activeTab === tab ? "none" : "1px solid oklch(0.28 0.04 265)",
    fontWeight: activeTab === tab ? "700" : "500",
    boxShadow: activeTab === tab ? "0 0 14px oklch(0.55 0.24 295 / 0.4)" : void 0
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: success ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2 space-y-4", children: [
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        target.distance !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "p",
                          {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: ["AFUK", "USDC", "ICP"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    style: tabStyle(tab),
                    children: [
                      tab === "AFUK" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "img",
                        {
                          src: "/assets/afuktokenlogo1-019d58aa-bef5-707a-b33c-a98d6dbac4d8.png",
                          alt: "AFUK",
                      ...
                      tab === "USDC" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                      ...
                      tab === "ICP" && /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-4 h-4" }),
                      tab
                    ]
                  },
                  tab
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    className: "space-y-3",
                    children: [
                      activeTab === "AFUK" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "p",
                              {
                                className: "text-xs",
                                style: { color: "oklch(0.60 0.04 265)" },
                                children: "Contract Address (ERC-20)"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(CopyableAddress, { address: AFUK_CONTRACT })
                          ]
                        }
                      ),
                      activeTab === "USDC" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "p",
                              {
                                ...
                                style: { color: "oklch(0.60 0.04 265)" },
                                children: "Stablecoin · 1 USDC = $1.00"
                              }
                            )
                          ]
                        }
                      ),
                      activeTab === "ICP" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: "rounded-xl p-3",
                          style: {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: QUICK_AMOUNTS[activeTab].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                            onClick: () => setAmount(v),
                            ...
                            style: {
                              background: amount === v ? "linear-gradient(135deg, oklch(0.55 0.24 295), oklch(0.62 0.24 340))" : "oklch(0.18 0.025 265)",
                              color: amount === v ? "white" : "oklch(0.60 0.04 265)",
                              border: "1px solid oklch(0.28 0.04 265)"
                            },
                            children: v
                          },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isSending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      ...
                      activeTab === "AFUK" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "img",
                        {
                          src: "/assets/afuktokenlogo1-019d58aa-bef5-707a-b33c-a98d6dbac4d8.png",
                          alt: "AFUK",
                      ...
                      activeTab !== "AFUK" && /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-4 h-4" }),
                      "Send ",
                      activeTab,
                      " Tip"
                    ] })
