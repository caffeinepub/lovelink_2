import { r as reactExports, j as jsxRuntimeExports, d as cn, E as ExternalBlob, b as ue } from "./index--RR2uuHP.js";
import { c as createContextScope, P as Primitive, a as useCallbackRef, u as useLayoutEffect2, L as Layout, M as MessageCircle } from "./Layout-D0gvy7ZP.js";
import { P as Presence, c as composeEventHandlers } from "./index-Dd1i9p_P.js";
import { u as useComposedRefs } from "./index-vqmhqKR0.js";
  ...
  if (msg.viewOnceState === "viewing") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: msg.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: msg.imageUrl,
            alt: "View once",
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-4xl opacity-60", children: "📸" }) })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function ChatWindow({
  ...
  const handleImageFile = async (file) => {
    ...
    try {
      ...
      console.error(err);
      ue.error("Failed to send image. Please try again.");
    } finally {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isUploading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showSheet && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ImageSourceSheet,
      {
        onChooseLibrary: () => {
          setShowSheet(false);
          setTimeout(() => {
            var _a;
            return (_a = libraryRef.current) == null ? void 0 : _a.click();
          }, 50);
        },
        onTakePhoto: () => {
          setShowSheet(false);
...
function MessagesPage() {
  ...
  const handleSendViewOnce = (imageUrl) => {
    const newMsg = {
      id: `${Date.now()}`,
      content: "",
      isSelf: true,
