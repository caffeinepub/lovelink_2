const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginPage-Czvo_w1B.js","assets/proxy-A24e9-ZM.js","assets/heart-C3grFkaB.js","assets/zap-DGjwg0Ib.js","assets/map-pin-Bbv46cBl.js","assets/ExplorePage-CelJEvY9.js","assets/Layout-C5EoH42h.js","assets/index-auF4jfXf.js","assets/TipModal-CjGeXBXV.js","assets/index-BZqUWHNL.js","assets/index-Byn3Q2lS.js","assets/label-byuGifbp.js","assets/index-CMm0yFNY.js","assets/coins-BFQcXQv6.js","assets/check-C7lCs4HX.js","assets/MatchesPage-C61-O1W7.js","assets/MessagesPage-CylRz4ID.js","assets/arrow-left-BIDzdM1F.js","assets/camera-C1icb58i.js","assets/ProfilePage-B0BGl2VT.js","assets/EditProfilePage-Bs47kHQx.js","assets/NotificationsPage-sdoKc55d.js","assets/WalletPage-B-yG5QKT.js"])))=>i.map(i=>d[i]);
...
function useNavigate() {
  return reactExports.useContext(RouterContext).navigate;
}
function useRouterPath() {
  return reactExports.useContext(RouterContext).path;
}
...
function RouterProvider({ children }) {
  const [path, setPath] = reactExports.useState(getHashPath);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RouterContext.Provider, { value: { path, navigate, params }, children });
}
function Route({ path, element, exact }) {
  const { path: currentPath } = reactExports.useContext(RouterContext);
  const matches = exact ? currentPath === path : currentPath.startsWith(path);
  return matches ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: element }) : null;
}
...
function Link({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${to}`, className, "data-ocid": dataOcid, ...props, children });
}
const DEFAULT_USER = {
  name: "You",
  gender: "Female",
...
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./LoginPage-Czvo_w1B.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const ExplorePage = reactExports.lazy(() => __vitePreload(() => import("./ExplorePage-CelJEvY9.js"), true ? __vite__mapDeps([5,6,7,1,2,8,9,10,11,12,4,13,14]) : void 0));
const MatchesPage = reactExports.lazy(() => __vitePreload(() => import("./MatchesPage-C61-O1W7.js"), true ? __vite__mapDeps([15,6,7,1,2,8,9,10,11,12,4,13,14]) : void 0));
const MessagesPage = reactExports.lazy(() => __vitePreload(() => import("./MessagesPage-CylRz4ID.js"), true ? __vite__mapDeps([16,6,7,1,2,10,17,18,12]) : void 0));
const ProfilePage = reactExports.lazy(() => __vitePreload(() => import("./ProfilePage-B0BGl2VT.js"), true ? __vite__mapDeps([19,6,7,1,2,4,18,13]) : void 0));
const EditProfilePage = reactExports.lazy(() => __vitePreload(() => import("./EditProfilePage-Bs47kHQx.js"), true ? __vite__mapDeps([20,6,7,1,2,11,17,4,14]) : void 0));
const NotificationsPage = reactExports.lazy(() => __vitePreload(() => import("./NotificationsPage-sdoKc55d.js"), true ? __vite__mapDeps([21,6,7,1,2,3,14,12]) : void 0));
const WalletPage = reactExports.lazy(() => __vitePreload(() => import("./WalletPage-B-yG5QKT.js"), true ? __vite__mapDeps([22,7,9,1,14]) : void 0));
...
function AppRoutes() {
  ...
  if (!isLoggedIn) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) });
  }
  if (path === "/" || path === "") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/explore" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/explore", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ExplorePage, {}), exact: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/matches", element: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchesPage, {}), exact: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/messages", element: /* @__PURE__ */ jsxRuntimeExports.jsx(MessagesPage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/profile/edit", element: /* @__PURE__ */ jsxRuntimeExports.jsx(EditProfilePage, {}), exact: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/profile", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfilePage, {}), exact: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/notifications", element: /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationsPage, {}), exact: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/wallet", element: /* @__PURE__ */ jsxRuntimeExports.jsx(WalletPage, {}), exact: true })
  ] });
}
function App() {
  const [isLoggedIn, setLoggedIn] = reactExports.useState(false);
  const [currentUser, _setCurrentUser] = reactExports.useState(DEFAULT_USER);
  const [walletAddress, setWalletAddress] = reactExports.useState(null);
  const setCurrentUser = (u) => _setCurrentUser((prev) => ({ ...prev, ...u }));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    AuthContext.Provider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(RouterProvider, { children: [
...
Service({
  ...
  "clearAllData": Func([], [], []),
  "createOrUpdateProfile": Func([Profile], [], []),
  "deleteProfile": Func([Principal2], [], []),
  "dislikeUser": Func([Principal2], [], []),
  "getActivityFeed": Func(
    [],
    [Vec(Tuple(Notification, Nat))],
    ["query"]
  ),
  "getAllProfiles": Func([], [Vec(Profile)], ["query"]),
  "getCallerProfile": Func([], [Opt(Profile)], ["query"]),
  "getCallerUserProfile": Func([], [Opt(Profile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getExploreProfiles": Func([], [Vec(Profile)], ["query"]),
  "getMatches": Func([], [Vec(Profile)], ["query"]),
  "getMessagesWithUser": Func(
    [Principal2],
    [Vec(Message)],
    ["query"]
  ),
  "getNotifications": Func([], [Vec(Notification)], ["query"]),
  "getProfile": Func([Principal2], [Opt(Profile)], ["query"]),
  "getTipHistory": Func([Principal2], [Vec(Tip)], ["query"]),
  "getTopTippedUsers": Func([], [Vec(Principal2)], ["query"]),
  "getTotalTips": Func([Principal2], [Nat], ["query"]),
  "getUserCount": Func([], [Nat], ["query"]),
  "getUserProfile": Func([Principal2], [Opt(Profile)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "isProfileComplete": Func([Principal2], [Bool], ["query"]),
  "likeUser": Func([Principal2], [Bool], []),
  "markAllNotificationsAsRead": Func([], [], []),
  "markNotificationAsRead": Func([Text], [], []),
  "saveCallerUserProfile": Func([Profile], [], []),
  "sendMessage": Func([Principal2, Text], [], []),
  "setProfilePicture": Func([ExternalBlob], [], []),
  "tip": Func([Principal2, Nat], [], [])
});
